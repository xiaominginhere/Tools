...
public class GlideUtils {
     ...
     * @param view     显示图片的View
     */
    public static void loadGifImage(Context mContext, Object loadUri, Drawable errorUri, ImageView view) {
        RequestOptions options = new RequestOptions();
        if (null != errorUri) {
            options.error(errorUri);
        }
     ...
     */
    public static void imageToBitmap(Context mContext, Object loadUri, Drawable errorUri, OnBitmapCallBack onBitmapCallBack) {
        RequestOptions options = new RequestOptions();
        if (null != errorUri) {
            options.error(errorUri);
        }
