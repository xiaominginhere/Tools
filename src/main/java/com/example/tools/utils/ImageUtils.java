...
public class ImageUtils {
    ...
    public static ImageUtils getInstance(Context mContent, OnImageCallBack onImageCallBack) {
        if (null == imageUtils) {
            imageUtils = new ImageUtils();
        }
        contextWeakReference = new WeakReference<>(mContent);
        imageUtils.setContextAndOnImageCallBack(contextWeakReference.get(), onImageCallBack);
        return imageUtils;
    }
     ...
     * 设置图片质量百分比
     */
    public ImageUtils setQuality(int quality) {
